...
* Установлено все необходимое программное обеспечение для работы с st-link v2
* Установлена программа st-flash (вы можете прошить микроконтроллер любой из имеющихся у вас утилит. Например, через stm32cubeprogrammer)
Прошить микроконтроллер средствами утилиты st-flash программатором st-link v2 можно введя следующие команды:
```sh
$ st-flash erase
$ st-flash write 0x08000000 aym.hex
```
